# Runs standalone via `Rscript tests/test_rental_market_module.R` (repo root) and under
...
test_that("rental_market_module contracts", {
  ...
  if (file.exists(module_path)) {
    ...
    required_module_text <- c(
      ...
      "NS(id)",
      "moduleServer",
      "rental_cost_measure_choices(",
      "rental_demographic_measure_data(",
      "rental_cost_measure_source_note(",
      'layout_column_wrap(',
      'width = "420px"',
