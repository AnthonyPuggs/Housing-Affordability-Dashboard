# Runs standalone via `Rscript tests/test_housing_supply_module.R` (repo root) and under
...
test_that("housing_supply_module contracts", {
  ...
  if (all(file.exists(c(helper_path, module_path)))) {
    ...
    required_ui_text <- c(
      ...
      "housing_supply-vb_selected_approvals",
      "housing_supply-vb_selected_approvals_date",
      "housing_supply-vb_selected_approvals_change",
      "housing_supply-vb_largest_approval",
      "housing_supply-vb_largest_approval_state",
