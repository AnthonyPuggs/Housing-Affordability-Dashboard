# Runs standalone via `Rscript tests/test_geographic_affordability_module.R` (repo root) and under
...
test_that("geographic_affordability_module contracts", {
