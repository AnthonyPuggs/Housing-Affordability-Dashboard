# Runs standalone via `Rscript tests/test_geographic_affordability_data_contracts.R` (repo root) and under
...
test_that("geographic_affordability_data_contracts contracts", {
