# Runs standalone via `Rscript tests/test_project_root_paths.R` (repo root) and under
...
test_that("project_root_paths contracts", {
  ...
  # Path-resolution checks below boot the full data layer; pin it to the
  # frozen fixtures so this code test cannot be broken by a data refresh.
  use_fixture_data()
