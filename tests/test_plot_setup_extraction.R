# Runs standalone via `Rscript tests/test_plot_setup_extraction.R` (repo root) and under
...
test_that("plot_setup_extraction contracts", {
  ...
  if (identical(plot_result, TRUE)) {
    expected_globals <- c(
      ...
      "rent_cpi_cities", "rent_cpi_city_cities", "rent_cpi_default_cities",
      "rent_cpi_coverage", "rent_cpi_national_city",
      "rent_cpi_national_range", "rent_cpi_city_range",
      "rppi_cities", "rba_cash_rate",
