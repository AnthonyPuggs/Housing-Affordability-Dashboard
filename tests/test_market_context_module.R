# Runs standalone via `Rscript tests/test_market_context_module.R` (repo root) and under
...
test_that("market_context_module contracts", {
  ...
  if (all(file.exists(c(helper_path, chart_builder_path, module_path)))) {
    ...
    required_ui_text <- c(
      ...
      "market_context-vb_underutilisation",
      "market_context-vb_underutilisation_change",
      "Household Debt to Income",
      "RBA E2, debt to annual disposable income",
      "market_context-vb_household_dti",
      "market_context-vb_household_dti_change",
  ...
  if (file.exists(module_path)) {
    ...
    required_module_text <- c(
      ...
      "latest_change(rba_rates, \"series\", \"Household debt to income\"",
      ...
      "latest_change(abs_ts, \"series\", \"Labour Underutilisation Rate\"",
