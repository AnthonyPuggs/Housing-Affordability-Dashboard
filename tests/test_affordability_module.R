# Runs standalone via `Rscript tests/test_affordability_module.R` (repo root) and under
...
test_that("affordability_module contracts", {
  ...
  if (all(file.exists(c(helper_path, scenario_path, module_path)))) {
    ...
    required_ui_text <- c(
      ...
      "affordability-calc_pathway",
      "Ownership serviceability",
      "Rental entry",
      ...
      "affordability-rent_weekly",
      "affordability-rent_to_income",
  ...
  if (file.exists(module_path)) {
    ...
    required_module_text <- c(
      ...
      'selectInput(ns("rent_preset")',
      'numericInput(ns("rent_weekly_input")',
      'numericInput(ns("rent_income")',
      'plotlyOutput(ns("afford_indices_chart")',
      'textOutput(ns("calc_repayment")',
      'textOutput(ns("rent_weekly")',
      'textOutput(ns("rent_to_income")',
      'textOutput(ns("rent_upfront_cash")',
      'textOutput(ns("rent_years_to_save")',
