...
`R/methodology_module.R`, `R/affordability_module.R` and `R/rental_market_module.R` are the first Shiny module pilots. They keep the registry-backed methodology/provenance page, Affordability page and Rental Market page isolated while broader page modularisation remains incremental.
