...
`R/methodology_module.R` and `R/affordability_module.R` are the first Shiny module pilots. They keep the registry-backed methodology/provenance page and the Affordability page isolated while broader page modularisation remains incremental.
