...
## Corpus Check
- 161 files · ~223,547 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1015 nodes · 1499 edges · 126 communities (93 shown, 33 thin omitted)
- Extraction: 89% EXTRACTED · 10% INFERRED · 1% AMBIGUOUS · INFERRED: 156 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b0fc4b6a`
...
1. `packages` - 17 edges
2. `affordabilityPageServer` - 17 edges
3. `Package` - 16 edges
4. `Authors@R` - 15 edges
5. `License` - 15 edges
6. `NeedsCompilation` - 15 edges
7. `Packaged` - 15 edges
8. `Author` - 15 edges
9. `Maintainer` - 15 edges
...
Cohesion: 0.05
Nodes (55): affordabilityPageServer, affordabilityPageUI, distributional_stress_data, build_affordability_indices_plot, build_cost_burden_heatmap_plot, build_distributional_stress_plot, build_dwelling_price_plot, build_housing_stress_bands_plot (+47 more)

### Community 3 - "Community 3"
Cohesion: 0.10
Nodes (24): ABS Data API Beta SDMX Service, ABS REST API XML JSON CSV Formats, ANSI Help and Run Links, renv Bootstrap, Bootstrap Download Sources, Profile-Specific renv Paths, Project Library Loading, renv Autoloader (+16 more)
...
Cohesion: 0.15
Nodes (19): data_vintage_badge, fmt_index, build_data_vintage, data_vintage_latest_period, data_vintage_row, data_vintage_summary, read_data_vintage, write_data_vintage (+11 more)
...
Cohesion: 0.20
Nodes (65): description, description, description, description, description, description, description, description (+57 more)
...
Cohesion: 0.08
Nodes (23): Affordability, Core Economic Validity Fixes, Do Not Overbuild, Evidence Base, Executive Verdict, Feature Matrix, Feature Removals Or De-Emphasis, Geographic Affordability (+15 more)
...
Cohesion: 0.13
Nodes (14): Analytical Methodology, CI / Automation, CLAUDE.md — Housing Affordability Dashboard, Commands, Deployment (Posit Connect Cloud), Domain Expertise, graphify, Key Conventions (+6 more)
...
Cohesion: 0.14
Nodes (13): 2.1 Serviceability v2 (the highest-value methodology upgrade) — M, 2.2 Fail-loud data layer — M, 2.3 Recent Buyers page (the one genuinely new feature ready to ship) — M, 2.4 Honest geography — M, 2.5 Test architecture migration — M/L, 2.6 Timelier market-entry data (post-survey-drought strategy) — M/L, Reconciliation with the 2026-05-31 recommended order, Rejected / out of scope (per the existing Do-Not-Overbuild list — unchanged) (+5 more)
...
Cohesion: 0.33
Nodes (5): Current V1 Diagnostics, Main Critiques, National Housing Affordability Score Review Memo, Required Interpretation Guardrails, Review Conclusion
...
Cohesion: 0.33
Nodes (5): Evidence, External review remediation — implementation record, Final verification, Implemented scope, Scope boundaries
...
## Knowledge Gaps
- **410 isolated node(s):** `PreToolUse`, `version`, `tasks`, `version`, `locale` (+405 more)
